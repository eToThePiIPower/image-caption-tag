...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A tag to create images with pretty captions for Jekyll and Octopress blogs.}
  spec.description   = %q{A tag to create images with pretty captions for Jekyll and Octopress blogs.}
